...
namespace Zaliczenie.Extensions
{
    ...
    {
        public static void MockStock(this Stock stock)
        {
            ...
            stock.Food = new Models.Categories.FoodCategory()
            {
                Products = new List<Models.Product>
                {
                    ...
                    new DrinkProduct("Coca-Cola", 10f, new DateTime(2023, 12, 12, 15, 0, 0, 0)),
                    new DrinkProduct("Beer", 3.20f, new DateTime(2023, 2, 20, 15, 0, 0, 0)),
                    new DrinkProduct("Wine", 3.20f, new DateTime(2023, 3, 11, 11, 0, 0, 0)),
                    new MeatProduct("Steak", 12, Enums.MeatType.Beef),
                    new MeatProduct("Rib", 15, Enums.MeatType.Pork),
                    new MeatProduct("Breast", 10, Enums.MeatType.Chicken),
